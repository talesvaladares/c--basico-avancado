...
namespace CursoCSharp.Api
{
    internal class ExemploTimeSpan
    {
        ...
        {
            var intervalo = new TimeSpan(days: 10, hours: 30, minutes:30, seconds: 40);
            ...
            Console.WriteLine(intervalo.Add(TimeSpan.FromMinutes(8))); //não altera o original, mas sim cria um novo
            Console.WriteLine(intervalo.Subtract(TimeSpan.FromMinutes(8))); //não altera o original, mas sim cria um novo
            Console.WriteLine(intervalo); //original
